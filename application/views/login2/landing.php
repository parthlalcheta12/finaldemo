...
<body>
                    ...
                    <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg);">
                        <div class="carousel-container">
                            <div class="carousel-content">
                                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Landing Page</span>
                                </h2>
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" id="profileDropdown" role="button" aria-expanded="false">
                            <img id="profileImage" src="<?php echo base_url('uploads/avatar1.jpg'); ?>" alt="Profile Picture"
                                class="rounded-circle" width="40" height="40">
                            <i class="bi bi-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                            <li><a href="#" class="dropdown-item" id="profileLink">Profile</a></li>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="<?php echo base_url('asset/img/about.jpg'); ?>" class="img-fluid" alt="">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="card">
                            <img src="<?php echo base_url('asset/img/more-service-1.jpg'); ?>" class="card-img-top"
                                alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="card">
                            <img src="<?php echo base_url('asset/img/more-service-2.jpg'); ?>" class="card-img-top"
                                alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="card">
                            <img src="<?= base_url('asset/img/more-service-3.jpg');?>" class="card-img-top" alt="...">
                            <div class="card-body">
                ...
                <div class="row portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-1.jpg'); ?>" class="img-fluid"
                                alt="">
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-1.jpg'); ?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-2.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 3</h4>
                                <p>Web</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?= base_url('assets/img/portfolio/portfolio-2.jpg')?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-3.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 2</h4>
                                <p>App</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-3.jpg')?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-4.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 2</h4>
                                <p>Card</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-4.jpg')?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-5.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 2</h4>
                                <p>Web</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-5.jpg'); ?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-6.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 3</h4>
                                <p>App</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-6.jpg'); ?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-7.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 1</h4>
                                <p>Card</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-7.jpg'); ?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-8.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 3</h4>
                                <p>Card</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('assets/img/portfolio/portfolio-8.jpg'); ?>"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="<?php echo base_url('asset/img/portfolio/portfolio-9.jpg'); ?>" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 3</h4>
                                <p>Web</p>
                            ...
                            <div class="portfolio-links">
                                <a href="<?php echo base_url('asset/img/portfolio/portfolio-9.jpg'); ?>"
                                    data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i
                                        class="bx bx-plus"></i></a>
                                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                            </div>
    ...
    $(document).ready(function() {
         $.ajax({
                url: '<?php echo base_url("ProfileController/getProfileImageName"); ?>',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    // return;
                    if (data.img) {
                        // If profile image name is available, update the src attribute
                        $('#profileImage').attr('src', '<?php echo base_url("uploads/"); ?>' + data.img);
                    }
                },
        ...
        $("#logoutLink").click(function(e) {
            ...
            if (confirm('Sure, Do you want to exit?') == true) {
        ...
        $('#profileLink').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url("Main/profile"); ?>',
                type: 'GET',
                // dataType: 'json',
                success: function(response) {
                    // Assuming you have elements in your HTML with ids to display user details
              



                    
                    // var profilePhotoUrl = '<?php echo base_url("uploads/"); ?>' + data.img;
                    // $('#inputUsername').val(data.username);
                    // $('#country').val(data.country_id);
                    // $('#state').val(data.state_id);
                    // $('#city').val(data.city_id);
                    // $('#inputPhone').val(data.contact);
                    // $('#inputBirthday').val(data.dob);
